...
def evaluate(qf, ql, qc, gf, gl, gc, gn=None):
    ...
    CMC_tmp = compute_mAP(index, qc, good_index, junk_index, gn)
    return CMC_tmp


def compute_mAP(index, qc, good_index, junk_index, gn):
    global dir_name
    ap = 0
    ...
    #                 os.path.join('data/market/retrieval_result', name))
