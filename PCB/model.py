...
class Fc_ClassBlock(nn.Module):
    def __init__(self, input_dim, class_num, dropout=0.5, relu=False, bnorm=True, num_bottleneck=512):
...
class ClassBlock(nn.Module):
    def __init__(self, input_dim=512, class_num=751, bnorm=False):
...
class PCB(nn.Module):
    def __init__(self, class_num, train=False):
        ...
        for i in range(self.part):
            ...
            # setattr(self, name, Fc_ClassBlock(2048, class_num, droprate=0.5, relu=False, bnorm=True, num_bottleneck=256))
            setattr(self, name, Fc_ClassBlock(2048, class_num, dropout= 0.5, relu=False, bnorm=True, num_bottleneck=512))
