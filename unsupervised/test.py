...
def test_function(test_dir=None, net_loss_model=None, which_epoch=None):
    if test_dir != None:
...
if __name__ == '__main__':
    test_function(test_dir=opt.test_dir, net_loss_model=opt.net_loss_model, which_epoch=opt.which_epoch)
