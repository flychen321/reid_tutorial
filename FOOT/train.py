...
import matplotlib
from datasets import ChannelDataset

matplotlib.use('agg')
import time
import os
from model import ft_net, save_network, save_whole_network, load_whole_network
...
parser.add_argument('--data_dir', default='gait', type=str, help='training dir path')
...
# image_datasets['train'] = ChannelDataset(train_path,
